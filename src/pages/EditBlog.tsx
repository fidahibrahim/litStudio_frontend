...
import { fetchBlogById, updateBlog } from '../service/api/user';
            ...
            try {
                ...
                if (response.data && response.data.data) {
                    ...
                    formik.setValues({
                        ...
                        image: blog.image ? 'existing-image' : '',
            ...
            <main className="flex-grow container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 mt-2">Update your blog with new content</p>
                    </div>
